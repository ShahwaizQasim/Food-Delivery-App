...
const formSchema = z.object({
  ...
  resumeUrl: z
    .any() // or z.instanceof(File) if using file objects
...
export default function JobApplicationPage() {
  ...
  useEffect(() => {
    if (jobId) {
      console.log("useEffect kay ander", jobId);
  ...
  const handleImageChange = (e) => {
    const file = e.target.files[0];
    if (file) {
      form.setValue("resumeUrl", file.name); // or use URL.createObjectURL(file) for a URL
    }
  };
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      formData.append("jobSeekerId", session?.data?.user.id);
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2 order-2 lg:order-1">
            <Card className="p-6 shadow-md">
              ...
              {isSubmitted ? (
                <div className="text-center py-10">
                  <div className="bg-green-100 text-blue-700 p-4 rounded-lg mb-6">
                    <h3 className="text-xl font-semibold mb-2">
                      Application Submitted!
                    </h3>
                    <p>
            ...
            <Card className="p-6 shadow-md">
              <div className="mb-6">
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <h3 className="text-lg font-semibold mb-1">Contact Email</h3>
                  <p className="text-gray-700">
